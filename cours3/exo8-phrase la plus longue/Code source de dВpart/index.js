...
{
    //document.write("<p>" + phrases[index] + phrases[index].length + "</p>");

    if (phrases[index].length > longest.length) {
        longest = phrases[index];  
     }
}


 document.write("<strong>" + "<p>" + "La phrase la plus longue est " + longest + "</p>" + "<strong>"); 
